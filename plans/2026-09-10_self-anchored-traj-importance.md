...
살아남는 논거는 **잡음 바닥** 하나다: calib_100을 50:50으로 갈라도 kept 겹침이
Q 0.860 / MLP 0.782. 앵커 교체가 그보다 크게 움직여야 잴 것이 있다 (→ G2).
...
| **G2** 잴 것이 있나 | `dual_u40_v2`와의 kept 겹침이 split-half 잡음 바닥(**Q 0.860 / MLP 0.782**)보다 **낮을 것** | 앵커 교체가 잡음 안. 보고하고 종료(빌드·평가 없음) |
