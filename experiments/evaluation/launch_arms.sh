...
set -u
# ALPAMAYO_REPO overrides the checkout, matching run_retry_host.sh: a worktree session
# must evaluate with ITS OWN code, or a checkpoint built against a patched slim_lib is
# loaded by the trunk's unpatched one.
